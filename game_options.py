...
def options_map(option: int, width: int, height:int , scale: int):
    ...
    if option == 1:
        return set([(row_mid,col_mid), (row_mid +1,col_mid), (row_mid + 2, col_mid),  (row_mid, col_mid + 1), (row_mid + 1, col_mid + 2)]) 

    if option == 2:
          return set([ (row_mid,col_mid), (row_mid + 1, col_mid), (row_mid + 3, col_mid),   (row_mid + 3,col_mid), (row_mid + 4, col_mid), (row_mid + 5, col_mid),   
